...
class FinanceAgent(Agent):
    ...
    def run_task(self, task_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if ticker and request_type:
                ...
                price, change, change_percent = self._extract_financial_data(response_content)
    ...
    def _parse_finance_query(self, query: str) -> Tuple[Optional[str], Optional[str]]:
        ...
        if ticker:
            if re.search(r'price|cost|worth|value', query, re.IGNORECASE):
                request_type = "price"
            elif re.search(r'change|movement|up|down|increase|decrease', query, re.IGNORECASE):
                request_type = "change"
            else:
    ...
    def _extract_financial_data(self, response: str) -> Tuple[Optional[float], Optional[float], Optional[float]]:
