...
try:
    from llamafind.search_engines import get_engine, get_available_engines, get_travel_engines
            ...
            try:
                ...
                for query in queries:
                    try:
                        ...
                        has_mlx_scores = all(result.rank is not None for result in results if result)
                        ...
                        logger.error(f"Error testing {engine_name} with query '{query}': {e}")
...
async def run_web_server():
    ...
    try:
        ...
        process = subprocess.Popen(
            [sys.executable, "run_llamafind.py", "--host", "127.0.0.1", "--port", "8000"],
...
def main():
    ...
    parser.add_argument("--web", action="store_true", help="Start web server after tests")
