...
class LlamaFindUltraTester:
    ...
    def test_vector_search(self, query: str = "LlamaFind Ultra") -> List[Dict[str, Any]]:
        """
    ...
    def save_results(self, output_file: str = "llamafind_ultra_test_results.json") -> None:
        """
    ...
    def print_summary(self) -> None:
        ...
        successful_tests = sum(1 for result in self.results.values() if result and result.get("success", False))
