...
def test_fallback_ranker():
    ...
    results = [
        SearchResult(title="Test A", url="https://example.com/a", snippet="Test result A", source="test"),
        SearchResult(title="Test B", url="https://example.com/b", snippet="Test result B with matching query", source="test"),
        SearchResult(title="Test C", url="https://github.com/test", snippet="Test result C", source="test"),
    ]
