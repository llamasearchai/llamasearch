...
def main() -> None:
    ...
    search_parser.add_argument(
        "--provider", "-p", type=str, default="google",
    ...
    search_parser.add_argument(
        "--include-domains", "-i", type=str, nargs="+",
        help="Only include results from these domains"
    )
    search_parser.add_argument(
        "--exclude-domains", "-e", type=str, nargs="+",
        help="Exclude results from these domains"
    )
    search_parser.add_argument(
        "--format", "-f", type=str, choices=["pretty", "json"],
    ...
    rag_parser.add_argument(
        "--max-tokens", "-t", type=int, default=500,
