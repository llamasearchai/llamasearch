...
def test_health_check(base_url):
    ...
    try:
        ...
        assert "LlamaFind Ultra API is running" in result["message"], "Unexpected message format"
        assert result["version"] == "1.0.0", f"Expected version '1.0.0', got '{result['version']}'"
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Test the basic LlamaFind Ultra API server")
