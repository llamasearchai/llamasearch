# Contributing to LlamaSearch

Thank you for your interest in contributing to LlamaSearch! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaSearch:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamasearch.git
   cd llamasearch
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamasearch.git
   ```
...
By contributing to LlamaSearch, you agree that your contributions will be licensed under the project's MIT License.
