...
def main():
    ...
    parser.add_argument("--cli", action="store_true", help="Run as command-line interface")
    parser.add_argument("--gui", action="store_true", help="Run as graphical user interface")
    ...
    if args.api:
        ...
        # Default to API mode
        logger.info(f"No mode specified, defaulting to API server on {args.host}:{args.port}")
        run_api(args.host, args.port)
