...
def main():
    ...
    parser.add_argument(
        "--basic", action="store_true", help="Only test basic endpoints (health check)"
    )
    parser.add_argument(
        "--skip-agents", action="store_true", help="Skip agent-related tests"
    )
    parser.add_argument(
        "--skip-search", action="store_true", help="Skip search endpoint tests"
    )
    parser.add_argument(
        "--skip-vector", action="store_true", help="Skip vector search tests"
    )
